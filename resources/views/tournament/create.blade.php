                        ...
                        <div class="bs-stepper">
                            <div class="bs-stepper-header" role="tablist">
                                ...
                                <div class="step" data-target="#tableaux-part">
                                    <button type="button" class="step-trigger" role="tab" aria-controls="tableaux-part"
                                        id="tableaux-part-trigger">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="form-group col-5">
                                            ...
                                            <input id="name" type="text" class="form-control" name="name" required
                                                autofocus placeholder="Le Nom du Tournoi">
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-5">
                                            <div class="form-group">
                                                ...
                                                <select id="type_tournament" name="type_tournament" class="form-control"
                                                    required>
                                                        ...
                                                        <tr>
                                                            {{-- <td>
                                                                <input type="checkbox" checked data-toggle="toggle"
                                                                    name="visible_tab[]" id="visible_tab"
                                                                    data-onstyle="primary" data-onstyle="danger">
                                                            </td> --}}
                                                            <td> <input id="nom_tableau" type="text"
                                                                    class="form-control" name="nom_tableau[]" required
                                                                    autofocus></td>
                                                            <td> <input type="date" id="debut" name="date[]"
                                                                    class="form-control" required>
                                                            </td>
                                                            <td> <input type="text" id="heure" name="heure[]"
                                                                    class="form-control" required placeholder="Fin">
                                                            </td>
                                                            <td> <input type="number" id="prix_tournoi"
                                                                    name="prix_tournoi[]" class="form-control" required>
                                                            </td>
                                                            <td> <input type="number" id="max_joueurs"
                                                                    name="max_joueurs[]" class="form-control" required>
                                                            </td>
                                                            ...
                                                            <td> <input type="number" id="points_mini"
                                                                    name="points_mini[]" class="form-control" required>
                                                            </td>
                                                            <td> <input type="number" id="points_max"
                                                                    name="points_max[]" class="form-control" required>
                                                            </td>
                                                            <td>
                                                                <div class="input-group">
                                                                    <input type="text" name="colors[]"
                                                                        class="form-control input-lg" value="#902100" />
                                                            ...
                                                            <td><button type="button" name="add" class="btn btn-success"
