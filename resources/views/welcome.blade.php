...
<body>
    ...
    <div class="site-wrap">
        ...
        <header class="site-navbar py-4 fixed-navbar" role="banner">
            <div class="container">
                <div class="d-flex align-items-center">
                    <div class="site-logo ">
                        <a href="{{ url('/') }}">
                            <img class="logo1" src="{{ asset('images/logo_TournamentManager.png') }}" alt="Logo">
                            <img class="logo2" src="{{ asset('images/logo_TournamentManager2.png') }}" alt="Logo2">
                        </a>
                    </div>
                    <div class="ml-auto">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                <li><a href="matches.html" class="nav-link">Tournois</a></li>
        ...
        <div class="hero overlay" style="background-image: url('assets/images/bg_tm.jpg');">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 ml-auto">
                        <h1 class="text-white">Tournament Manager</h1>
                        <p>L'outil indispensable pour votre club et les joueurs de tennis de
                            table.
                        </p>
                        <p>Avec TOURNAMENT MANAGER, pour les la gestion des inscriptions ne sera plus une corvée.
                            Et pour les joueurs, vous pourrez gérer en tout autonomie vos inscriptions.
                        </p>
                        {{-- <div id="date-countdown"></div> --}}
                        <p>
                            <a href="#" class="btn btn-primary py-3 px-4 mr-3">Se connecter</a>
                            <a href="#" class="more light">Tutoriel</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex team-vs">
                        <span class="score">Les Tournois</span>
    ...
    <!-- JavaScript Bootstrap (optionnel si vous n'utilisez pas de fonctionnalités spécifiques de Bootstrap) -->
